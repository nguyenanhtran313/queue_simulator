...
- Nền canvas xám rất nhạt — set ở **cấp trang** (`page.json` → `objects.outspace`/`objects.background`, không phải ở theme) = `#F5F6F8`. Card/chart/table nền trắng (`background = #FFFFFF`, kế thừa từ Theme).
